...
export default {
  ...
  computed: {
    classes () {
      let base = 'cookie-banner '
      if (this.type) base += `cookie-banner--${this.type} `
      return base
    },
  }
};
