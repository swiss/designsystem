<template>
  <div class="transcript">
    ...
    <div class="transcript__row">
      ...
      <div class="transcript__speaker">Interviewer</div>
      <div class="transcript__text">
        Was it the one that came in with the computer when you bought it? [laughs]
      </div>
    </div>
    <div class="transcript__row">
    ...
    <div class="transcript__row">
      ...
      <div class="transcript__speaker">Interviewee</div>
      <div class="transcript__text">
        I would probably have to say from the Fallout series, I would probably have to say Fallout 3 because it was the first larger game that I ever played and the experience of playing it was just so immersive and everything seemed endless, like endless opportunities. So I would definitely go with that one.
      </div>
    </div>
    <div class="transcript__row">
      ...
      <div class="transcript__speaker">Interviewer</div>
      <div class="transcript__text">
        Okay. In your opinion do others besides teens and children play video games?
      </div>
    </div>
    <div class="transcript__row">
    ...
    <div class="transcript__row">
      ...
      <div class="transcript__speaker">Interviewee</div>
      <div class="transcript__text">
        Or people that you meet over the Internet or in a video game, definitely and more people to have things in common, definitely.
      </div>
    </div>
    <div class="transcript__row">
      ...
      <div class="transcript__speaker">Interviewer</div>
      <div class="transcript__text">
        Okay. That brings us to another point. So, do you think that gaming is addictive?
      </div>
    </div>
    <div class="transcript__row">
    ...
    <div class="transcript__row">
      ...
      <div class="transcript__speaker">Interviewer</div>
      <div class="transcript__text">
        Yes, so you do agree that gaming kind of increases aggression then? Because you brought that up already.
      </div>
    </div>
    <div class="transcript__row">
    ...
    <div class="transcript__row">
      ...
      <div class="transcript__speaker">Interviewee</div>
      <div class="transcript__text">
        Okay, what do you mean? How do you mean beneficial or do you want to-- [crosstalk]
      </div>
    </div>
    <div class="transcript__row">
      ...
      <div class="transcript__speaker">Interviewer</div>
      <div class="transcript__text">
        Beneficial in the sense that do you get anything out of it. Do you get any positive experiences or--?
      </div>
    </div>
    <div class="transcript__row">
    ...
    <div class="transcript__row">
      ...
      <div class="transcript__speaker">Interviewer</div>
      <div class="transcript__text">
        Okay, so then do you think that video games contribute to skill development?
      </div>
    </div>
    <div class="transcript__row">
    ...
    <div class="transcript__row">
      ...
      <div class="transcript__speaker">Interviewer</div>
      <div class="transcript__text">
        True. Okay, so what do you think the video games will be like in the future?
      </div>
    </div>
    <div class="transcript__row">
