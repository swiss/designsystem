...
- `btn--outline` for standard buttons with `data-default-theme="dark"`
- `btn--bare` for buttons without strokes with `data-default-theme="dark"`

<Canvas className="storybook-bg-negative" of={BtnStories.NegativeTypes} />
...
<Canvas className="storybook-bg-negative" of={BtnStories.NegativeButtonLinks} />
