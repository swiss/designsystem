...
<Canvas>
    <button type="button" class="btn btn--base btn--outline">btn--outline</button>
    <button type="button" class="btn btn--base btn--bare">btn--bare</button>
    <button type="button" class="btn btn--base btn--filled">btn--filled</button>
</Canvas>
...
<Canvas style={{backgroundColor: '#2f4356'}}>
    <button type="button" class="btn btn--base btn--outline-negative">btn--outline-negative</button>
    <button type="button" class="btn btn--base btn--bare-negative">btn--bare-negative</button>
</Canvas>
...
<Canvas>
    <button type="button" class="btn btn--outline btn--sm">btn--sm</button>
    <button type="button" class="btn btn--outline btn--base">btn--base</button>
    <button type="button" class="btn btn--outline btn--lg">btn--lg</button>
</Canvas>
