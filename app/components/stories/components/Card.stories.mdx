      ...
      <div style="${args.layout == 'default' ? 'max-width: 600px; margin: auto' : ''}">
        <Card :type="type" :layout="layout" :has-icon="${args.image == 'WithIcon'}">
          ...
          <template v-if="${args.footerAction == 'InternalLink' || args.footerAction == 'ExternalLink' }" v-slot:footerAction>
            <a href="#" v-if="${args.footerAction == 'InternalLink'}" aria-label="Weiterlesen" class="btn btn--outline btn--icon-only "><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="btn__icon icon icon--base icon--ArrowRight "><path xmlns="http://www.w3.org/2000/svg" d="m16.444 19.204 4.066-7.044-4.066-7.044-.65.375 3.633 6.294h-15.187v.75h15.187l-3.633 6.294z"></path></svg> <span class="btn__text">
              Weiterlesen
            </span></a>
            <a href="#" v-if="${args.footerAction == 'ExternalLink'}" rel="external" aria-label="Weiterlesen" class="btn btn--outline btn--icon-only "><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="btn__icon icon icon--base icon--ArrowUpRight "><path xmlns="http://www.w3.org/2000/svg" d="m20.2 14.3-2.1-7.9-7.9-2.1-.1.7 7 1.9-10.7 10.7.5.5 10.7-10.7 1.9 7z"></path></svg> <span class="btn__text">
              Weiterlesen
            </span></a>
          </template>
        </Card>
