      ...
      <div style="max-width: 600px; margin: auto">
        <Card :type="type">
          ...
          <template v-if="${args.footerAction == 'InternalLink' || args.footerAction == 'ExternalLink' }" v-slot:footerAction>
            <button v-if="${args.footerAction == 'InternalLink'}" type="button" aria-label="Weiterlesen" class="btn btn--outline btn--icon-only "><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="btn__icon icon icon--base icon--ArrowRight "><path xmlns="http://www.w3.org/2000/svg" d="m16.444 19.204 4.066-7.044-4.066-7.044-.65.375 3.633 6.294h-15.187v.75h15.187l-3.633 6.294z"></path></svg> <span class="btn__text">
              Weiterlesen
            </span></button>
            <button v-if="${args.footerAction == 'ExternalLink'}" type="button" aria-label="Weiterlesen" class="btn btn--outline btn--icon-only "><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="btn__icon icon icon--base icon--ArrowUpRight "><path xmlns="http://www.w3.org/2000/svg" d="m14.46 4.85v.75h4.171l-5.99 5.988.531.531 5.988-5.989v4.17h.75v-5.45z"></path><path xmlns="http://www.w3.org/2000/svg" d="m18.118 19.151h-12.508v-12.508h4.701v-.75h-5.451v14.008h14.008v-5.451h-.75z"></path></svg> <span class="btn__text">
              Weiterlesen
            </span></button>
          </template>
