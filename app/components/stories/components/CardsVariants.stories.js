...
const TemplateCardArticle = (args, { argTypes }) => ({
...
const TemplateCardEvent = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  components: { Card, Btn, SvgIcon },
  template: `<div>
  <div style="padding: 3em;" class="bg--secondary-50">
...
const TemplateCardShare = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  components: { Card, Btn, SvgIcon },
  template: `<div>
  <div style="padding: 3em;" class="bg--secondary-50">
...
const TemplateCardHub = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
...
export const ArticleOrNewsItem = {
  render: TemplateCardArticle.bind({}),
...
export const EventItem = {
  render: TemplateCardEvent.bind({}),
  name: 'Event item',
  args: {},
}

export const SharingItem = {
  render: TemplateCardShare.bind({}),
  name: 'Sharing item',
  args: {},
}
