  ...
  template:
    ...
    <div class="section section--default">
        <div class="container">
          ...
          />
          <div>
            Some random content herheSome random content herheSome random content herheSome random content herheSome random content herheSome random content herheSome random content herheSome random content herheSome random content herhe
          </div>
        </div>
      </div>
    `,
