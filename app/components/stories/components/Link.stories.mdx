...
<Canvas style={{ backgroundColor: '#2f4356' }}>
  ...
  <a class="link link--negative link--external">Negative external link</a>
</Canvas>

## Links with icons

Use the `.btn btn--link` component and its variants to display a link with an icon. 
<a href="?path=/docs/components-button--example#btn-links">Read more about Button component</a>
<Canvas>
  <a href="tel: +41 31 123 4567" class="btn btn--link">
