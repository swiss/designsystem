...
- See explanations [here](https://www.nngroup.com/articles/new-browser-windows-and-tabs/) and [here](https://css-tricks.com/use-target_blank/)
- The main justified case for opening links in new windows is to avoid the user losing data (work, forms, etc) in the current window.
...
- the user completely leave your domain (xx.admin.ch -> example.com)
