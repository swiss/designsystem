    ...
    `
      <main>
        ...
        <Btn
          ...
          id="trigger-2"
        />
        <Modal title="${args.title}" triggerElements="${args.triggerElements}" layout="${args.layout}">
...
The `Modal` component allow to display content on top of the page, in an overlay.
