...
The default newsletter component have small spacings and can for example be placed in a sidebar on a [Detail Page Complex](http://localhost:3003/?path=/docs/pages-detail-page-complex--example).
