...
<fieldset class="form__group">
  ...
  <div class="form__group__radio">
    <input type="radio" id="radio-0" name="radio-group-1" class="input input--outline input--error" value="value-0" />
    <label for="radio-0" class="">
      Label for value one
    </label>
  </div>
  <div class="form__group__radio">
    <input type="radio" id="radio-1" name="radio-group-1" class="input input--outline input--error" value="value-1" />
    <label for="radio-1" class="">
      Label for value two
    </label>
  </div>
  <div class="form__group__radio">
    <input type="radio" id="radio-2" name="radio-group-1" class="input input--outline input--error" value="value-2" />
    <label for="radio-2" class="">
      Label for value three
    </label>
  </div>
