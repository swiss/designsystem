<template>
  <div>
    ...
    />
    <Wrapper
      classes="flex flex-wrap items-start md:space-x-2 space-y-2 md:space-y-0 flex-col md:flex-row"
    ...
    >
      <Button classes="btn-active" role="button" aria-pressed="true"
        >neutral</Button
      >
      <Button classes="btn-primary btn-active" role="button" aria-pressed="true"
        >primary</Button
      >
      <Button
        classes="btn-secondary btn-active"
        role="button"
        aria-pressed="true"
        >secondary</Button
      >
      <Button classes="btn-accent btn-active" role="button" aria-pressed="true"
        >accent</Button
      >
      <Button classes="btn-link btn-active" role="button" aria-pressed="true"
        >link</Button
      >
    </Wrapper>
    ...
    <Wrapper
      classes="flex flex-wrap items-start space-x-2 flex-row"
      title="responsive buttons"
    >
      <Button classes="btn-xs md:btn-sm lg:btn-md xl:btn-lg"
    ...
    >
      <div
        class="p-20 bg-cover card bg-base-200"
    ...
    <Wrapper
      classes="flex flex-wrap items-start space-y-2 flex-col"
      title="button wide"
    >
    ...
    >
      ...
      <Button classes="btn-sm btn-outline btn-secondary loading"
        >loading</Button
      >
    ...
    >
      <Button classes="btn-primary no-animation"
        >I don't have click animation</Button
      >
    </Wrapper>
  </div>
</template>
