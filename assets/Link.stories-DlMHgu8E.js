...
}`,...(k=(u=n.parameters)==null?void 0:u.docs)==null?void 0:k.source}}};var v,g,h;t.parameters={...t.parameters,docs:{...(v=t.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <a class="link link--negative">Negative Link</a>
    \`
  })
}`,...(h=(g=t.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};var L,x,_;r.parameters={...r.parameters,docs:{...(L=r.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <main>
        <p>
...
}`,...(_=(x=r.parameters)==null?void 0:x.docs)==null?void 0:_.source}}};var f,S,b;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <main>
        <p>Sed luctus pharetra nunc, et egestas <a href="http://admin.ch" rel="external">sementical external</a> at. Donec volutpat ex et enim <a href="http://admin.ch" class="link--external">forced external</a> gravida vehicula.</p>
