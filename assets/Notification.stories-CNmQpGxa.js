import{_ as w}from"./Notification-SkDsDue6.js";const _={title:"Components/Notification",component:w,argTypes:{isClosed:{table:{category:"props"}},type:{table:{type:{summary:["string: info, warning, error, success, alert, hint"]}},options:["info","warning","error","success","alert","hint"],control:{type:"select"}},heading:{options:["h2","h3","h4","h5"],control:{type:"select"}},icon:{options:["InfoCircle","WarningCircle","CancelCircle","HelpCircle","CheckmarkCircle",void 0],control:{type:"select"}}}},i={args:{type:"info",icon:"InfoCircle",text:'<p>This is a notification with an <a href="#" target="_blank"> external link</a>.</p>',title:"Notification Title",heading:"h2",closeBtn:!0,isClosed:!1}},n={render:()=>({template:`
        <div>
      ...
      `})};var o,s,e;i.parameters={...i.parameters,docs:{...(o=i.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    type: 'info',
    icon: 'InfoCircle',
...
}`,...(e=(s=i.parameters)==null?void 0:s.docs)==null?void 0:e.source}}};var c,d,r;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => ({
    template: \`
        <div>
          <div class="notification notification--hint">
...
}`,...(r=(d=n.parameters)==null?void 0:d.docs)==null?void 0:r.source}}};var l,v,p;a.parameters={...a.parameters,docs:{...(l=a.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: () => ({
    template: \`
        <div>
          <div class="notification notification--info">
...
}`,...(p=(v=a.parameters)==null?void 0:v.docs)==null?void 0:p.source}}};var f,h,m;t.parameters={...t.parameters,docs:{...(f=t.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => ({
    template: \`
        <div>
        <div class="notification notification--info">
...
}`,...(m=(h=t.parameters)==null?void 0:h.docs)==null?void 0:m.source}}};const z=["Example","NotificationTypes","NotificationTypesWithIcons","ComplexContent"],u=Object.freeze(Object.defineProperty({__proto__:null,ComplexContent:t,Example:i,NotificationTypes:n,NotificationTypesWithIcons:a,__namedExportsOrder:z,default:_},Symbol.toStringTag,{value:"Module"}));export{t as C,i as E,u as N,n as a,a as b};
