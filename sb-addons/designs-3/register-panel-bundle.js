...
`+e.id,i=Yt.get(s);return i||(i=Ut(o.absoluteBoundingBox,e.absoluteBoundingBox),Yt.set(s,i)),[...i.map(n=>mr({guide:n,reverseScale:t})),...i.map(n=>gr({guide:n,reverseScale:t,fontSize:r}))]},Gt=A`
  .distance-line {
    shape-rendering: geometricPrecision;
    fill: none;
    opacity: 0;
